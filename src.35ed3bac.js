...
},{"./isObject":"u9vI","./now":"pJf5","./toNumber":"iS0Z"}],"SvwL":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;const e="https://restcountries.com/v3.1",t="?fields=name,capital,population,flags,languages";function s(s){return fetch(`${e}/name/${s}${t}`).then(e=>e.json())}var o=s;exports.default=o;
},{}],"Focm":[function(require,module,exports) {
"use strict";require("./css/styles.css");var e=r(require("lodash/debounce")),t=require("./fetchCountries");function r(e){return e&&e.__esModule?e:{default:e}}const u=300,s=document.querySelector("#search-box");s.addEventListener("input",(0,e.default)(handleInput,300)),s.addEventListener("submit",e=>{e.preventDefault()});
},{"./css/styles.css":"krre","lodash/debounce":"CXfR","./fetchCountries":"SvwL"}]},{},["Focm"], null)
//# sourceMappingURL=/goit-js-hw-10/src.35ed3bac.js.map